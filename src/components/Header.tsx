      ...
      <nav className="w-full px-3 sm:px-6 py-2 sm:py-4">
        <div className="flex justify-between items-center gap-2">
          ...
          <Link to="/" className="flex items-center gap-2 min-w-0 flex-shrink-0">
            ...
            <span className="text-[11px] sm:text-base md:text-xl font-bold text-primary dark:text-accent leading-tight whitespace-nowrap">
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-3 space-y-1 pb-3 border-t border-gray-100 dark:border-gray-700 pt-3 animate-fade-in">
            {homeLinks.map(link => (
              isHome ? (
