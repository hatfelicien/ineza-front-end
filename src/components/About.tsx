    ...
    <section id="about" className="py-16 sm:py-20 bg-gray-50 dark:bg-gray-800 bg-pattern relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        <div className={`text-center mb-12 sm:mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 dark:text-white mb-6">About Ineza Foundation</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className={`bg-accent/20 h-52 sm:h-80 md:h-96 rounded-lg overflow-hidden hover:scale-105 transition-all duration-1000 border-2 border-accent ${isVisible ? 'opacity-100 -translate-x-0' : 'opacity-0 -translate-x-20'}`}>
