                ...
                <button
                  ...
                  className={`px-6 py-2.5 rounded-full font-semibold text-sm transition-all duration-300 hover:scale-105 ${
                    activeCategory === cat
                      ...
                      : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-primary/10 border border-gray-200 dark:border-gray-600'
                  }`}
                >
                  {cat}
                </button>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filtered.slice(1).map((post, index) => (
                <div
                  ...
                  className={`group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl cursor-pointer transition-all duration-500 hover:-translate-y-2 ${
