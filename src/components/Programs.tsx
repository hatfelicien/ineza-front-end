          ...
          {programs.map((program, index) => (
            ...
            >
              <div className="flip-card-inner h-full">
                {/* Front */}
                <div className="flip-card-front bg-primary rounded-xl shadow-lg p-8 flex flex-col items-center justify-center text-white">
                  <div className="text-6xl mb-4">{program.icon}</div>
                  <h3 className="text-2xl font-bold text-center">{program.title}</h3>
                </div>
                
                {/* Back */}
                <div className="flip-card-back bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 flex flex-col items-center justify-center border-2 border-primary">
                  <p className="text-gray-700 dark:text-gray-300 text-center leading-relaxed">{program.description}</p>
                </div>
              </div>
            </div>
          ))}
